...
This code governs the construction, alteration, relocation, and change of use of every structure within the model jurisdiction, except detached one-family dwellings of not more than two storeys, which are governed by the Model Residential Code.

Exception: Agricultural sheds of not more than 400 square feet in floor area that are not open to the public.
...
No structure shall be erected, enlarged, altered, moved, or have its use changed without a permit issued by the building official.

### 105.2 Work exempt from permit

Exceptions:
1. One-storey detached accessory structures of not more than 150 square feet in floor area.
2. Fences not more than 6 feet high.
3. Retaining walls not more than 3 feet high measured from the bottom of the footing, unless supporting a surcharge.
4. Painting, wallpapering, tiling, carpeting, and similar finish work.
5. Replacement of windows and doors in the same opening without structural change.
...
Unless otherwise expressly stated, the terms in Section 202 have the meanings shown for the purposes of this code. Where a term is not defined, its ordinary meaning applies.

## SECTION 202 DEFINITIONS

ACCESSIBLE ROUTE. A continuous, unobstructed path connecting accessible elements and spaces of a building or site that complies with Chapter 11.
...
| Group | Name | Typical uses |
|---|---|---|
| A | Assembly | Theatres, halls, restaurants, arenas |
| B | Business | Offices, clinics, banks, training rooms |
| E | Educational | Schools for grades K through 12 |
| F | Factory | Manufacturing, assembling, repair |
| H | High-hazard | Storage or use of hazardous materials above allowed quantities |
| I | Institutional | Hospitals, care facilities, detention |
| M | Mercantile | Retail stores, markets, showrooms |
| R | Residential | Hotels, apartments, dormitories |
| S | Storage | Warehouses, parking garages |
| U | Utility | Barns, sheds, towers |

### 302.2 Mixed uses

Where a building contains more than one occupancy group, it shall comply with Section 508 for mixed occupancies.
...
Group A occupancies are divided into subgroups A-1 through A-5 according to the nature of the gathering. A-1 covers theatres with fixed seating, A-2 covers food and drink consumption, A-3 covers worship and recreation, A-4 covers indoor sporting events with spectator seating, and A-5 covers outdoor viewing structures.
...
Group R includes the use of a building or portion thereof for sleeping purposes when not classified as institutional. R-1 covers transient hotels and motels, R-2 covers apartment buildings and dormitories with more than two dwelling units, R-3 covers buildings with not more than two dwelling units, and R-4 covers residential care facilities for 6 to 16 persons.
...
|---|---|---|---|---|---|
| A-2, A-3 | Unlimited | 3 | 3 | 3 | 2 |
| B | Unlimited | 5 | 5 | 5 | 3 |
| E | Unlimited | 3 | 3 | 3 | 1 |
| M | Unlimited | 4 | 4 | 4 | 2 |
| R-2 | Unlimited | 4 | 4 | 4 | 3 |
| S-1 | Unlimited | 4 | 3 | 4 | 2 |
...
2. Mezzanines in Group F or Group S occupancies within buildings of Type I or II construction may be increased to two-thirds of the floor area where the mezzanine is used for storage of noncombustible materials only.
...
|---|---|---|---|---|
| A-2 | Unlimited | 15,500 | 14,000 | 6,000 |
| B | Unlimited | 23,000 | 19,000 | 9,000 |
| M | Unlimited | 21,500 | 18,500 | 9,000 |
| R-2 | Unlimited | 24,000 | 24,000 | 7,000 |
| S-1 | Unlimited | 26,000 | 26,000 | 9,000 |
...
The frontage increase shall be computed as If = (F/P - 0.25) multiplied by W/30, where F is the building perimeter fronting on a public way or open space, P is the total perimeter, and W is the width of the open space limited to 30 feet.
...
| Occupancy pair | Sprinklered | Non-sprinklered |
|---|---|---|
| A and B | 1 | 2 |
| A and M | 1 | 2 |
| B and R-2 | 1 | 2 |
...
2. Openings are not limited where the opening protective has been tested as a fire barrier assembly at the required rating.
...
Exceptions:
1. Corridor walls permitted to have a one-half-hour rating by Table 1020.1.
2. Dwelling unit and sleeping unit separations in buildings of Type IIB, IIIB, and VB construction that are sprinklered throughout, which are permitted a one-half-hour rating.
...
| Wall assembly | Wall rating (hours) | Door rating (minutes) |
|---|---|---|
| Fire wall | 4 | 180 |
| Fire wall | 3 | 180 |
| Fire barrier (exit enclosure) | 2 | 90 |
| Fire barrier (exit enclosure) | 1 | 60 |
| Fire partition (corridor) | 1 | 20 |
| Fire partition (corridor) | 0.5 | 20 |
| Smoke barrier | 1 | 20 |
...
Approved automatic sprinkler systems shall be provided in the locations described in Sections 903.2.1 through 903.2.8.
...
3. Control valves that are locked in the open position.
...
2. Manual fire alarm boxes are not required where the building is sprinklered throughout and notification appliances activate on water flow.
...
| Educational shops and vocational rooms | 50 net |
...
| Occupancy | Maximum occupant load of space | Maximum common path, sprinklered (feet) | Maximum common path, non-sprinklered (feet) |
|---|---|---|---|
| A, E, M | 49 | 75 | 75 |
| B | 49 | 100 | 75 |
| F | 49 | 100 | 75 |
| H-1, H-2, H-3 | 3 | 25 | Not permitted |
| I-2 | 10 | 75 | Not permitted |
| R-2 | 10 | 125 | Not permitted |
| S | 29 | 100 | 75 |
| U | 49 | 100 | 75 |
...
| Occupant load per storey | Minimum number of exits |
|---|---|
| 1 to 500 | 2 |
| 501 to 1,000 | 3 |
| More than 1,000 | 4 |
...
2. Door openings to storage closets less than 10 square feet in area are not required to comply with the minimum width.
3. Door openings providing access to bathrooms within individual dwelling units shall have a clear width of not less than 28 inches.
...
2. Doors within or serving a single dwelling unit in Group R-2 and R-3.
3. Revolving doors complying with Section 1010.3.
...
2. Changes in room floor elevation of three or fewer risers within dwelling units do not require handrails.
...
TABLE 1017.2 EXIT ACCESS TRAVEL DISTANCE IN FEET
...
Exceptions:
1. In Group F-1 and S-1 occupancies of a single storey, the travel distance may be increased to 400 feet where the building is sprinklered throughout and has a smoke and heat removal system complying with Section 910.
2. In Group B occupancies the travel distance may be measured to an exterior exit door at grade where the door discharges directly to a public way.
...
| Occupancy | Occupant load served | Without sprinkler system | With sprinkler system |
|---|---|---|---|
...
2. Thirty-six inches for corridors serving an occupant load of less than 50.
3. Thirty-six inches within a dwelling unit.
4. Seventy-two inches in Group E with a corridor having an occupant load of 100 or more.
5. Seventy-two inches in corridors serving movable-bed patient rooms in Group I-2.
6. Ninety-six inches in Group I-2 corridors where required for the movement of beds.
...
2. Levels that do not contain accessible elements or other spaces required by Section 1107 or 1108 are not required to be served by an accessible route from an accessible level.
...
2. If any room has a furred ceiling, the prescribed ceiling height is required in two-thirds of the area thereof, but in no case shall the height of the furred ceiling be less than 7 feet.
3. The height of mezzanines and spaces below mezzanines shall be not less than 7 feet.
